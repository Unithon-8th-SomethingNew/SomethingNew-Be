...
public class NotificationController {
    ...
    @GetMapping("/knock/accept")
    public void knockAccept(){

    }

    @GetMapping("/knock/reject")
    public ResponseEntity<String> knockReject(@RequestParam("userId") Long userId) throws InterruptedException{
        AndroidPushPeriodicNotifications androidPushPeriodicNotifications = new AndroidPushPeriodicNotifications(userService);
        String notification = androidPushPeriodicNotifications.rejectNotificationJson(userId);
